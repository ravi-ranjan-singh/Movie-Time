  ...
  render() {
    return (
      <div className="container">
        <div className="row"><Navbar onSearch={this.handleSearch.bind(this)} likedMovies={this.state.liked}/>
        </div>
        <Content movie={this.state.movie} onLiked={this.handleLike} likedMovies={this.state.liked}/>
      </div>
    );
  }
}
